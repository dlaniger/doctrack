	...
	<div class="span12">
		...
		<div id="target-1" class="widget">
			...
			<div class="widget-content">
				<div align="center" class="span12"><h1>RECEIVE DOCUMENT</h1></div>
				<div class="span5">
					<div class="widget">
				...
				<div class="tab-pane" id="formcontrols" >
					{{ Form::open(array('url' => 'tracking/trackingrecieve', 'method' => 'post', 'class'=>'form-horizontal form-label-left')) }}
					<fieldset>
						<div class="control-group">											
							...
							<div class="controls">
								...
								<input type="hidden" name="tracking_id" value="{{$proc_id}}">
								<input type="hidden" name="track_id" value="{{$track_det->tracking_id}}">
							</div> <!-- /controls -->
						</div> <!-- /control-group -->
