...
@elseif(getLogindetails()->usertype_id==4 or getLogindetails()->usertype_id==2)
<div class="span6">

	<div class="widget widget-table action-table">
		<div class="widget-header"> <i class="icon-th-list"></i>
			<h3>Recieve Documents</h3>
		</div>
		<!-- /widget-header -->
		<div class="widget-content">
			<table class="table table-striped table-bordered">
				...
				<tbody>
					@foreach ($active as $act)
					<tr>
						<td class="td-actions"><a href="{{ url('/tracking/recieve')}}/{{$act->tracking_id}}/{{$act->track_proc_id}}" class="btn btn-small btn-primary">View</a></td>
						<td> {{$act->doc_title}} </td>
						<td> {{$act->doc_desc}} </td>
					</tr>
					@endforeach
...
<div class="span6">
	...
	<div id="target-2" class="widget widget-table action-table">
		<div class="widget-header"> <i class="icon-th-list"></i>
		...
		<div class="widget-content">
			<table class="table table-striped table-bordered">
				...
				<tbody>
					...
					<tr>
						<td class="td-actions"><a href="{{ url('/tracking/release')}}/{{$close->tracking_id}}/{{$close->track_proc_id}}" class="btn btn-small btn-primary">View</a></td>
						<td> {{$close->doc_title}} </td>
						<td> {{$close->doc_desc}} </td>
					</tr>
					@endforeach
				</tbody>
			</table>
