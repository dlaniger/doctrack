	...
	<div class="span12">
		<div id="target-1" class="widget">
			...
			<div class="widget-content">
				...
				@endif 
				{{ Form::open(array('url' => '/references/offices/editsave', 'method' => 'post', 'class'=>'form-horizontal')) }}
				<form id="edit-profile" class="form-horizontal">
					<fieldset>
						<input type="hidden" name="assoc_of_id" id="assoc_of_id" value="{{$off->assoc_of_id}}">
						<div class="control-group">
							{{ Form::label('inst_desc', 'Name', array('class' => 'control-label')) }}									
							<div class="controls">
								<input type="text" class="span6" id="assoc_of_desc" name="assoc_of_desc" value="{{$off->assoc_of_desc}}" required>
							</div> <!-- /controls -->					
						</div> <!-- /control-group -->
